...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({ConcurrentStockUpdateException.class, OptimisticLockingFailureException.class})
    public ResponseEntity<ErrorResponse> handleConcurrentUpdate(
            RuntimeException ex, HttpServletRequest request) {
        return buildResponse(HttpStatus.CONFLICT,
                "Stock was updated concurrently, please retry the request", request, null);
    }
